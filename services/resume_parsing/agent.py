...
from services.resume_parsing.supabase_client import get_profile_data, update_profile_intelligence
from services.resume_parsing.profile_models import (
    ProfileIntelligence,
    InferredJobRole,
)
from services.resume_parsing.models import ParsedResume, Project
