...
class JobIngestionEmbeddingTests(unittest.TestCase):
    def _run(self, jobs, embedding_side_effect, existing_hashes=None):
        ...
        with patch.object(job_ingestion, "generate_job_embedding", side_effect=embedding_side_effect) as mock_embed, \
    ...
    def test_embedding_generated_for_both_new_and_already_active_jobs(self):
        ...
        stats, mock_upsert, _ = self._run(jobs, embedding_side_effect=lambda title, desc, skills: [0.1, 0.2])
